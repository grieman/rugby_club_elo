    ...
    for index, row in scores_df.iterrows():
        ...
        for i in range(1, len(row)):
            if len(row[i]) > 0:
                ...
                match_record = {'Home_Club':home_club, 'Home_Score':home_score, 'Away_Score':away_score, 'Away_Team':away_team}
...
# FROM http://www.ipernews.com/RUGBY/guinness_19871988.htm
match_scores.Week = [8, 27, 3, 0, 15, 4, 15, 9, 7, 13, 29, 24, 5, 30, 4, 18, 14, 2, 17, 9, 28, 19, 30, 13, 4, 26, 18, 29, 21, 2, 16, 6, 25, 13, 27, 9, 22, 14, 7, 18, 29, 7, 0, 12, 1, 0, 12, 24, 20, 11, 0, 30, 6, 2, 23, 12, 28, 17, 14, 29, 10, 8, 17, 26]

### ELO
# margin of victory: ln(MOV) + 1 * K to get score change
